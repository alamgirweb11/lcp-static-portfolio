...
@section('content')
    ...
    <div class="ex-basic-1 pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-fluid mt-5 mb-3" src="{{ asset('images/project-details-large.jpg') }}" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <img class="img-fluid mb-5" src="{{ asset('images/project-details-small.jpg') }}" alt="alternative">
                    ...
                    <a class="btn-solid-reg mb-5" href="{{ route('home') }}">Back</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of ex-basic-1 -->
